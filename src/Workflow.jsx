...
import { Box, Container, Card, CardHeader, CardActions, CardContent, TextField, Divider, Switch, Typography, Autocomplete, List, ListItem, ListItemText, IconButton, Tooltip, Button, ListItemAvatar, ListItemButton, Avatar, Stack, Popover, Checkbox, Chip } from '@mui/material';
                    ...
                    <Box className="workflow-details">
                        ...
                        <Card variant="outlined" sx={{mt:2}}>
                            ...
                            >
                                ...
                                {(selectedApproverList && selectedApproverList.length>0) && selectedApproverList.map(el => (
